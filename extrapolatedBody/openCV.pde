  ...
  if (armOpenCvUpdate) {
    ...
    for (Contour contour : contours) {   
      ...
      if (area > minContourArea && area < maxContourArea) {
        ...
        PShape childRect = createShape(ELLIPSE, rect.x, rect.y, rect.width, rect.height);
        childRect.setStrokeWeight(1);        
        childRect.setStroke(color(rect.x+100, rect.y+30, 240));
        ...
        childCentroid.stroke(rect.x+100, rect.y+30, 240);
